...
public class ConfiguracionAdminController {
    ...
    public ConfiguracionAdminController(UsuarioService usuarioService, MessageSource messageSource) {
    ...
    public String configuracion(Authentication authentication, Model model) {
        return cargarConfiguracion(authentication, model, "vista");
    }

    @GetMapping("/editar")
    public String editar(Authentication authentication, Model model) {
        return cargarConfiguracion(authentication, model, "editar");
    }
    ...
    public String actualizar(@RequestParam String nombre,
        ...
        try {
            ...
            return "redirect:/admin/configuracion/confirmacion";
            ...
            return "redirect:/admin/configuracion/editar";
        }
    }

    @GetMapping("/confirmacion")
    public String confirmacion(Authentication authentication, Model model) {
        return cargarConfiguracion(authentication, model, "confirmacion");
    }

    private String cargarConfiguracion(Authentication authentication, Model model, String modo) {
